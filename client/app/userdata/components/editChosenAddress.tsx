...
interface editChosenAddressProps {
clicked:boolean
...
export default function  EditChosenAddress({currentEditAddress,setCurrentEditAddress,setClicked,clicked }:editChosenAddressProps) {
  const updateAddress =async (currentEditAddress:address,selectedAddressID:string) => {
    ...
    try {
      const res = await fetch(`http://localhost:3000/updateAddress`, {
          ...
          credentials: 'include',
          body: JSON.stringify({ currentEditAddress ,addressId:selectedAddressID}),
      })
  ...
  <div className="flex justify-center">
    <button
      onClick={() => {
        ...
        updateAddress(currentEditAddress as address,currentEditAddress._id as string);
      }}
