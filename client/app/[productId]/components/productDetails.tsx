...
<div className="border-2 border-gray-600 shadow-2xl bg-gray-50 rounded-2xl p-4   flex flex-col sm:flex-row  justify-center items-center sm:justify-center  sm:items-stretch   gap-4 h-fit w-full  ">

<div className="flex flex-col h-96  gap-2 relative w-full max-w-[320px] sm:w-[70%] rounded-2xl overflow-hidden shadow-lg border-2 border-gray-300">
    <img 
